    ...
    <div className="centered-page-container">
      <div className="centered-content-card">
        <section className="impressum-section">
          ...
          <p>
            Urheberrechte und Markenrechte: Alle auf dieser Website dargestellten Inhalte, wie Texte, Fotografien, Grafiken,
            Marken und Warenzeichen sind durch die jeweiligen Schutzrechte (Urheberrechte, Markenrechte) geschützt. Die Verwendung,
