...
// SVG for the split flag button
const SplitFlagButton = ({ onClick, currentLang }) => (
  <button
    onClick={onClick}
    className="lang-toggle-btn"
    aria-label="Switch to English / Deutsch"
    title={currentLang === 'de' ? "Switch to English" : "Zu Deutsch wechseln"}
  >
    <svg viewBox="0 0 60 40" width="45" height="30" className="split-flag">
      <defs>
        <clipPath id="split-diagonal">
      ...
      <path d="M0,0 L60,40 M60,0 L0,40" stroke="#cf142b" strokeWidth="2" />
      <path d="M30,0 L30,40 M0,20 L60,20" stroke="white" strokeWidth="10" />
      <path d="M30,0 L30,40 M0,20 L60,20" stroke="#cf142b" strokeWidth="6" />

      {/* Germany Flag (Foreground, clipped diagonally) */}
      <g clipPath="url(#split-diagonal)">
        <rect x="0" y="0" width="60" height="13.33" fill="black" />
        <rect x="0" y="13.33" width="60" height="13.33" fill="#dd0000" />
        <rect x="0" y="26.66" width="60" height="13.33" fill="#ffce00" />
      </g>

      {/* Border */}
      <rect x="0" y="0" width="60" height="40" fill="none" stroke="#ccc" strokeWidth="1" />
    </svg>
  </button>
);
...
const GermanContent = () => (
  <>
    <section className="impressum-section">
      ...
      <p>
        E-Mail-Adresse: <a href="mailto:contact@chainlines.cc">contact@chainlines.cc</a>
      </p>

      <h2 id="m154">Journalistisch-redaktionelle Angebote</h2>
      <p>Inhaltlich verantwortlich: Frédéric Jung, Heerfleckenstr. 8, 91056 Erlangen</p>

      <h2 id="m65">Haftungs- und Schutzrechtshinweise</h2>
      <p>
        Haftungsausschluss: Die Inhalte dieses Onlineangebotes wurden sorgfältig und nach unserem aktuellen Kenntnisstand
        erstellt, dienen jedoch nur der Information und entfalten keine rechtlich bindende Wirkung, sofern es sich nicht um
        gesetzlich verpflichtende Informationen (z.&nbsp;B. das Impressum, die Datenschutzerklärung oder verpflichtende
        Belehrungen von Verbrauchern) handelt. Wir behalten uns vor, die Inhalte vollständig oder teilweise zu ändern oder zu
        löschen, soweit vertragliche Verpflichtungen unberührt bleiben. Alle Angebote sind freibleibend und unverbindlich.
      </p>
      <p>
        Links auf fremde Webseiten: Die Inhalte fremder Webseiten, auf die wir direkt oder indirekt verweisen, liegen außerhalb
        unseres Verantwortungsbereiches und wir machen sie uns nicht zu Eigen. Für alle Inhalte und Nachteile, die aus der
        Nutzung der in den verlinkten Webseiten aufrufbaren Informationen entstehen, übernehmen wir keine Verantwortung.
      </p>
      <p>
        Urheberrechte und Markenrechte: Alle auf dieser Website dargestellten Inhalte (Texte, Fotografien, Grafiken,
        Marken) sind durch die jeweiligen Schutzrechte geschützt. Die <strong>kuratierte Datenbank der Radsport-Team-Historien</strong>
        wird jedoch unter der <strong>Creative Commons Attribution-ShareAlike 4.0 International (CC-BY-SA 4.0)</strong>
        Lizenz zur Verfügung gestellt. Individuelle historische Fakten sind gemeinfrei.
      </p>
      <p>
        Hinweise auf Rechtsverstöße: Sollten Sie innerhalb unseres Internetauftritts Rechtsverstöße bemerken, bitten wir Sie
        uns auf diese hinzuweisen. Wir werden rechtswidrige Inhalte und Links nach Kenntnisnahme unverzüglich entfernen.
      </p>
    ...
    <section className="privacy-section">
      ...
      <ul className="index">
        ...
        <li><a className="index-link" href="#m451">Single-Sign-On-Anmeldung</a></li>
      ...
      <p>Frédéric Jung<br />Heerfleckenstr. 8<br />91056 Erlangen</p>
      <p>E-Mail-Adresse: <a href="mailto:contact@chainlines.cc">contact@chainlines.cc</a></p>
      ...
      <ul className="m-elements">
        ...
        <li><strong>Hetzner: </strong>Leistungen auf dem Gebiet der Bereitstellung von informationstechnischer Infrastruktur und verbundenen Dienstleistungen (z.&nbsp;B. Speicherplatz und/oder Rechenkapazitäten); <strong>Dienstanbieter:</strong> Hetzner Online GmbH, Industriestr. 25, 91710 Gunzenhausen, Deutschland; <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); <strong>Website:</strong> <a href="https://www.hetzner.com" target="_blank" rel="noreferrer">https://www.hetzner.com</a>; <strong>Datenschutzerklärung:</strong> <a href="https://www.hetzner.com/de/rechtliches/datenschutz" target="_blank" rel="noreferrer">https://www.hetzner.com/de/rechtliches/datenschutz</a>. <strong>Auftragsverarbeitungsvertrag:</strong> <a href="https://docs.hetzner.com/de/general/general-terms-and-conditions/data-privacy-faq/" target="_blank" rel="noreferrer">https://docs.hetzner.com/de/general/general-terms-and-conditions/data-privacy-faq/</a>.</li>
      </ul>
      ...
      <ul className="m-elements">
        ...
        <li><strong>Betroffene Personen:</strong> Nutzer (z.&nbsp;B. Webseitenbesucher, Nutzer von Onlinediensten).</li>
        <li><strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher Leistungen und Erfüllung vertraglicher Pflichten; Sicherheitsmaßnahmen; Anmeldeverfahren. Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit.</li>
      ...
      <p><strong>Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</strong></p>
      <ul className="m-elements">
        <li><strong>Google Single-Sign-On: </strong>Authentifizierungsdienste für Nutzeranmeldungen, Bereitstellung von Single Sign-On-Funktionen, Verwaltung von Identitätsinformationen und Anwendungsintegrationen; <strong>Dienstanbieter:</strong> Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland; <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); <strong>Website:</strong> <a href="https://www.google.de" target="_blank" rel="noreferrer">https://www.google.de</a>; <strong>Datenschutzerklärung:</strong> <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer">https://policies.google.com/privacy</a>; <strong>Grundlage Drittlandtransfers:</strong> Data Privacy Framework (DPF). <strong>Widerspruchsmöglichkeit (Opt-Out):</strong> Einstellungen für die Darstellung von Werbeeinblendungen: <a href="https://myadcenter.google.com/" target="_blank" rel="noreferrer">https://myadcenter.google.com/</a>.</li>
        <li className="google-disclosure">
          <strong>Google API Services User Data Policy:</strong> Die Nutzung und Übertragung von Informationen, die von Google-APIs erhalten wurden, an eine andere App durch ChainLines erfolgt in Übereinstimmung mit der <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer">Google API Services User Data Policy</a>, einschließlich der Bestimmungen zur eingeschränkten Nutzung (Limited Use requirements).
          Wir erfassen über den Google-Login lediglich Ihren vollständigen Namen, Ihre E-Mail-Adresse und Ihr Profilbild.
          Diese Daten werden ausschließlich zur Authentifizierung und zur Personalisierung Ihrer Benutzererfahrung innerhalb unserer Applikation verwendet.
          Wir geben diese Daten nicht an Dritte weiter, verkaufen sie nicht und nutzen sie nicht für Werbezwecke oder das Training von KI-Modellen außerhalb der spezifischen Funktionalitäten dieser App (z. B. Moderations-Workflows).
        </li>
      </ul>
      ...
      <p>Wir bitten Sie, sich regelmäßig über den Inhalt unserer Datenschutzerklärung zu informieren. Wir passen die Datenschutzerklärung an, sobald die Änderungen der von uns durchge-führten Datenverarbeitungen dies erforderlich machen. Wir informieren Sie, sobald durch die Änderungen eine Mitwirkungshandlung Ihrerseits (z.B. Einwilligung) oder eine sonstige individuelle Benachrichtigung erforderlich wird.</p>
      <p>Sofern wir in dieser Datenschutzerklärung Adressen und Kontaktinformationen von anderen Stellen angeben, bitten wir zu beachten, dass die Adressen sich über die Zeit ändern können und bitten die Angaben vor Kontaktaufnahme zu prüfen.</p>
...
const EnglishContent = () => (
  <>
    <section className="impressum-section">
      ...
      <p>
        E-Mail: <a href="mailto:contact@chainlines.cc">contact@chainlines.cc</a>
      </p>

      <h2>Editorial Responsibility</h2>
      <p>Responsible for content: Frédéric Jung, Heerfleckenstr. 8, 91056 Erlangen, Germany</p>

      <h2>Liability and Copyright Information</h2>
      <p>
        <strong>Disclaimer:</strong> The contents of this online offer have been created with care and according to our current knowledge, but serve only for information purposes and do not have legally binding effect, unless it is legally mandatory information. We reserve the right to change or delete contents fully or partially. All offers are subject to change and non-binding.
      </p>
      <p>
        <strong>External Links:</strong> We assume no liability for the content of external websites linked directly or indirectly. The operators of the linked pages are solely responsible for their content.
      </p>
      <p>
        <strong>Copyright and Trademarks:</strong> All content displayed on this website (texts, photographs, graphics, brands) is protected by the specific intellectual property rights. However, the <strong>curated database of cycling team histories</strong> is made available under the <strong>Creative Commons Attribution-ShareAlike 4.0 International (CC-BY-SA 4.0)</strong> license. Individual historical facts are considered public domain.
      </p>
      <p>
        <strong>Legal Violations:</strong> Should you notice any legal violations within our internet presence, please ask you to inform us. We will remove illegal content and links immediately upon becoming aware of them.
      </p>
    </section>
    ...
    <section className="privacy-section">
      ...
      <h2>Preamble</h2>
      <p>With the following privacy policy, we would like to inform you about the types of your personal data (hereinafter also referred to as "data") we process, for what purposes, and to what extent within the scope of providing our application.</p>
      <p>The terms used are not gender-specific.</p>

      <p>Status: December 8, 2025</p>

      <h2>Responsible Person</h2>
      <p>Frédéric Jung<br />Heerfleckenstr. 8<br />91056 Erlangen<br />Germany</p>
      <p>E-Mail: <a href="mailto:contact@chainlines.cc">contact@chainlines.cc</a></p>

      <h2>Overview of Processing</h2>
      <p>The following overview summarizes the types of data processed and the purposes of their processing.</p>
      <h3>Types of Processed Data</h3>
      <ul>
        <li>Inventory data (e.g., names).</li>
      ...
      <ul>
        ...
        <li> managing and responding to inquiries and feedback.</li>
        <li>Authentication processes (Single Sign-On).</li>
      </ul>

      <h2>Legal Bases</h2>
      <p><strong>Relevant legal bases under the GDPR:</strong> Consent (Art. 6 (1) (a) GDPR), Contract performance (Art. 6 (1) (b) GDPR), Legal obligation (Art. 6 (1) (c) GDPR), Legitimate interests (Art. 6 (1) (f) GDPR).</p>

      <h2>Security Measures</h2>
      <p>We take appropriate technical and organizational measures to ensure a level of protection appropriate to the risk, in accordance with legal requirements, taking into account the state of the art, implementation costs, and the nature of the data.</p>
      <p>Measures include specifically TLS/SSL encryption (HTTPS) to protect data transmitted via our online services.</p>

      <h2>International Data Transfers</h2>
      <p>Data processing in third countries generally takes place in accordance with legal requirements (e.g., standard contractual clauses or Data Privacy Framework DPF for USA).</p>

      <h2>Data Retention and Deletion</h2>
      <p>We delete personal data as soon as the purpose for its processing ceases to apply or consents are revoked, unless statutory retention obligations exist (e.g., 10 years for tax documents in Germany).</p>

      <h2>Rights of Data Subjects</h2>
      <p>You have the right to object, revoke consent, request information, rectification, deletion, data portability, and to lodge a complaint with a supervisory authority.</p>

      <h2>Provision of Online Services and Web Hosting</h2>
      <p>We process user data to provide our online services. This includes IP addresses necessary for delivering content.</p>
      <ul className="m-elements">
        <li><strong>Hosting Provider:</strong> Hetzner Online GmbH (Germany).</li>
      </ul>

      <h2>Single-Sign-On Authentication</h2>
      <p>We use Single-Sign-On procedures (Google OAuth) to allow users to sign in.</p>
      <ul className="m-elements">
        <li><strong>Processed Data:</strong> Name, Email Address, Profile Picture.</li>
      ...
      <p><strong>Specific Services:</strong></p>
      <ul className="m-elements">
        <li><strong>Google Single-Sign-On: </strong>Provider: Google Ireland Limited.</li>
        <li className="google-disclosure">
          <strong>Google API Services User Data Policy:</strong> The use and transfer to any other app of information received from Google APIs will adhere to <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer">Google API Services User Data Policy</a>, including the Limited Use requirements.
          We only collect your full name, email address, and profile picture via Google Login.
          This data is used exclusively for authentication and personalizing your user experience within our application.
          We do not share this data with third parties, do not sell it, and do not use it for advertising purposes or for training AI models outside the specific functionalities of this app.
        </li>
      </ul>
    </section>
  </>
  ...
  return (
    <CenteredPageLayout>
      <Card
        ...
        headerActions={<SplitFlagButton onClick={toggleLang} currentLang={lang} />}
      >
