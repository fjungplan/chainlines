...
/**
 * GeometricParametersSection - Global weights and geometric parameters
 * @param {Object} config - Full configuration object
 * @param {function} onChange - Callback with updated config
 */
export default function GeometricParametersSection({ config, onChange }) {
    ...
    return (
        <div className="settings-section shared-parameters-section">
            <h2>Geometric & Cost Parameters</h2>
